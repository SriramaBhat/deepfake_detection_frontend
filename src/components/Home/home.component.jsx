    ...
    <div className="home">
      ...
      <FadeInSection>
        <section className="about-us" id="about-us">
          <h2>About Us</h2>
          <p className="text">
          In the current age, the widespread availability of advanced AI technologies has given rise to a
serious issue that needs to be addressed, i.e., the proliferation of Deepfake content. Deepfakes
are media, typically generated by deep learning algorithms such as CNNs, Generative Adversarial Networks (GANs), and its variants, which can convincingly manipulate or replace
visual and audio elements in videos, audio recordings, and images</p>
          
         <p className="text1">This project aims to address this growing challenge of identifying and mitigating the
impact of DeepFake content. This project has an objective to leverage cutting-edge artificial
intelligence and machine learning techniques to develop a robust and efficient system for
detecting DeepFake content across various media formats.</p>
          <div className="images">
          <article>
          <img src={kevin} alt="modi" width="190px"></img>
              <h3>Kevin Thomas</h3>
            </article>
            <article>
            <img src={modi} alt="modi" width="220px" ></img>
              <h3>Hardik Modi</h3>
            </article>
            <article>
              <img src={sriram} alt="modi" width="219px"></img>
              <h3>Srirama Bhat</h3>
            </article>
            <article>
              <img src={yashas} alt="modi" width="185px"></img>
      ...
      <h2>Our Methodology</h2>
          <p>
          Our methodology revolves around advanced AI analysis and a rigorous examination process to determine the authenticity of digital content.

File Upload: Users can simply upload their files through our user-friendly interface. Veritasium supports various file formats, allowing you to analyze text, images, and audio content.

AI Analysis: Our platform utilizes deep learning models to scrutinize the uploaded content. We leverage sophisticated algorithms that have been trained to distinguish between human-generated and AI-generated content.

Verification Result: After a comprehensive analysis, Our project provides a clear and concise verification result. Users receive detailed insights into whether the file is likely to be generated by AI.
          </p>
      <img src={architechture} alt="Methodology" className="methodology-image" />
