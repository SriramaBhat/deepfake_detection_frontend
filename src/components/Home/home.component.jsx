          ...
          <FadeInSection>
            <div className="about-container">
              <h2>Welcome to Veritasium!</h2>
                <h3><div class="wrapper">
                <ul class="dynamic-txt">
                  <li><span>Trust, Transparency, Veritasium</span></li>
                  <li><span> Seamless Content Verification</span></li>
                  <li><span>Thorough Analysis, Instant Results</span></li>
                  
                </ul>
          </div></h3>
              <p>
               Our website employs advanced algorithms to determine
               whether an audio clip, text, or image has been generated by 
               artificial intelligence. 
               Easy to use and accessible, simply upload your file, 
               and we'll provide you with a quick analysis,
               letting you know if it's AI-generated or not.
              </p>
            </div>
          </FadeInSection>
        </div>
